...
class Query {
  ...
  subQuery(sobject) {
    ...
    let sort = query.sort && model.strict ? model.transformer.formatKeys(query.sort) : query.sort;
    let select = query.select && model.strict ? model.transformer.formatKeys(query.select) : query.select;
    let where = query.where && model.strict ? model.transformer.formatKeys(query.where) : query.where;
